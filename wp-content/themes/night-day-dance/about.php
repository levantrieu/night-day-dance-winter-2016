  ...
  <main id="main" class="site-main" role="main">
    ...
    <div class="container">
      ...
      <section class="about-content">
        ...
        <button class="ab-desktop" type="submit">contact us</button>
      </section>

      <div class="about-location">Location</div>

      <section class="location">
        <p>You can find us around BC and even in Alberta - in Vancouver, Victoria, New West, the Sunshine Coast, and Edmonton!</p>
        <p class="desktop-location">You can find us around BC and even in Alberta - in Vancouver, Victoria, New West, the Sunshine Coast, and Edmonton! Check out the maps of our locations below. We offer most private lessons in the privacy of our home studies.</p>
        <button class="ac-desktop" type="submit">contact us</button>
      </section>

      <div class="about-buttons">
        <button class="about-book" type="submit">contact us</button>
